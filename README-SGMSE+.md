...
source ~/.bashrc &&  export CUDA_VISIBLE_DEVICES=0 && time python3 enhancement.py --test_dir /vol/grid-solar/sgeusers/liangxu/data/voicebank/test --enhanced_dir /workspace/exp_code/sgmse/out/test_enhanced --ckpt  /workspace/exp_code/sgmse/logs/ip4hsocu-None/step=250000.ckpt

source ~/.bashrc &&  export CUDA_VISIBLE_DEVICES=2 && time python3 enhancement.py --test_dir /vol/grid-solar/sgeusers/liangxu/data/voicebank/voice_bank_sample --enhanced_dir /workspace/exp_code/sgmse/out/test_enhanced --ckpt  /workspace/exp_code/sgmse/logs/ip4hsocu-None/step=250000.ckpt


source ~/.bashrc &&  export CUDA_VISIBLE_DEVICES=1 && time python3 enhancement.py --test_dir /vol/grid-solar/sgeusers/liangxu/data/voicebank/test --enhanced_dir /workspace/exp_code/sgmse/out/test_enhanced115 --ckpt  ./train_vb_29nqe0uh_epoch=115.ckpt
```
...
```bash
python3 calc_metrics.py --clean_dir /workspace/exp_code/sgmse/out/test_enhanced/clean --noisy_dir /workspace/exp_code/sgmse/out/test_enhanced/noisy  --enhanced_dir /workspace/exp_code/sgmse/out/test_enhanced

python3 calc_metrics.py --test_dir /vol/grid-solar/sgeusers/liangxu/data/voicebank/test --enhanced_dir /workspace/exp_code/sgmse/out/test_enhanced115

...
CHECKPOINTS_WITH_PARAMS=(
    "./logs/Teacher_model/vcrsnu58/last.ckpt,260,0"
    "./logs/Teacher_model/vcrsnu58/last.ckpt,520,0"
    "./logs/Teacher_model/vcrsnu58/last.ckpt,260,3"
    "./logs/Teacher_model/vcrsnu58/last.ckpt,520,3"
    "./logs/Teacher_model/vcrsnu58/last.ckpt,-1,0"
)
